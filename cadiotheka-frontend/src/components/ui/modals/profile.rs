            ...
            <div class="flex items-start gap-4">
                ...
                <div class="min-w-0 flex-1 flex flex-col gap-1">
                    ...
                    <div class="flex flex-col gap-0.5 text-xs text-base-content/60">
                        <span class="inline-flex items-center gap-1 tooltip tooltip-top" data-tip={format!("Email: {}", account.email)}>
                        ...
                        <span class="inline-flex items-center gap-1 tooltip tooltip-top" data-tip={format!("Joined: {}", format_time_full(account.created_at))}>
                            <svg class="w-3.5 h-3.5 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
