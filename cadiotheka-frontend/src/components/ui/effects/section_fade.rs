...
pub fn FadeOverlay(
    ...
    match position {
        ...
        "bottom" => view! {
            ...
            .into_any(),
        "spotlight-top" => view! {
            <div class={format!("absolute inset-x-0 top-0 h-{} bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-primary/20 via-transparent to-transparent pointer-events-none", height)} />
        }
            .into_any(),
        "spotlight-bottom" => view! {
            <div class={format!("absolute inset-x-0 bottom-0 h-{} bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-primary/20 via-transparent to-transparent pointer-events-none", height)} />
        }
            .into_any(),
        _ => view! {
            <>
