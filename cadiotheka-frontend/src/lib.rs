...
pub mod data {
    ...
    pub use project::{
        IconUrl, ProjectData, ProjectPatch, create_project, delete_project, fetch_projects,
        new_project_payload, toggle_project_favorite, update_project, update_project_collaborators,
